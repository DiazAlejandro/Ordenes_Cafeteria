...
public class TipoIngredienteJpaController implements Serializable {
    ...
    public void create(TipoIngrediente tipoIngrediente) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findTipoIngrediente(tipoIngrediente.getIdting()) != null) {
                throw new PreexistingEntityException("TipoIngrediente " + tipoIngrediente + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void edit(TipoIngrediente tipoIngrediente) throws NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            TipoIngrediente persistentTipoIngrediente = em.find(TipoIngrediente.class, tipoIngrediente.getIdting());
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = tipoIngrediente.getIdting();
